...
public class FindFriendsActivity extends AppCompatActivity
{
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerAdapter<Contacts, FindFriendViewHolder> adapter =
                new FirebaseRecyclerAdapter<Contacts, FindFriendViewHolder>(options) {
                    ...
                    {
                        holder.userNombre.setText(model.getNombre());
                        holder.userDireccion.setText(model.getDireccion());
                        holder.userTelefono.setText(model.getTelefono());
    ...
    {
        TextView userNombre, userDireccion, userTelefono;
        ...
        public FindFriendViewHolder(@NonNull View itemView)
        {
            ...
            userNombre = itemView.findViewById(R.id.users_profile_name);
